...
const User = ({id}) => {
    ...
    const fetch = async (id) => {
        ...
        try {
            const res = await axios.get(`https://60851effd14a870017577685.mockapi.io/api/v1/users/${id}`);
    ...
    async function deleteItem() {
        ...
        try {
            const res = await axios.delete(`https://60851effd14a870017577685.mockapi.io/api/v1/users/${id}`);
